...
INSERT INTO sys_permission (id,name,permission) VALUES (1,'list-users','userInfo:list');
INSERT INTO sys_permission (id,name,permission) VALUES (2,'create-user','userInfo:create');
INSERT INTO sys_permission (id,name,permission) VALUES (3,'read-user','userInfo:read');
INSERT INTO sys_permission (id,name,permission) VALUES (4,'update-user','userInfo:update');
INSERT INTO sys_permission (id,name,permission) VALUES (5,'delete-user','userInfo:delete');
